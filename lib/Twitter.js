...
Twitter.prototype.postDirectMessagesWelcomeMessagesNew = function (params, error, success) {
    var path = '/direct_messages/welcome_messages/new.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};
...
Twitter.prototype.doPost = function (url, post_body, error, success) {
    ...
    var header = (post_body == null)? 'application/json': "application/x-www-form-urlencoded"
    this.oauth.post(url, this.accessToken, this.accessTokenSecret, post_body, header, function (err, body, response) {
