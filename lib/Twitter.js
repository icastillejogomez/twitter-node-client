...
function Twitter(config, callback) {
  ...
  this.oauth2 = new OAuth2(
    ...
    'oauth2/token',
    null);
  this.oauth2.getOAuthAccessToken( '', {'grant_type':'client_credentials'}, function (e, access_token, refresh_token, results){
...
Twitter.prototype.doRequest = function (url, error, success) {
    ...
    /*
    this.oauth.get(, this.accessToken, this.accessTokenSecret, function (err, body, response) {
    ...
    */
    ...
    this.oauth2.get(url, this.access_token, function(err, data, res) {
