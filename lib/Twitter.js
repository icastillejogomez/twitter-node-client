...
Twitter.prototype.postMutesUsersCreate = function (params, error, success) {
    var path = '/mutes/users/create.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};

Twitter.prototype.postMutesUsersDestroy = function (params, error, success) {
    var path = '/mutes/users/destroy.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};

Twitter.prototype.postSavedSearchesCreate = function (params, error, success) {
    var path = '/saved_searches/create.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};

Twitter.prototype.postSavedSearchesDestroy = function (params, error, success) {
    var path = '/saved_searches/destroy/:id.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};

Twitter.prototype.postTweetDestroy = function (params, error, success) {
    var path = '/statuses/destroy/:id.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};
...
Twitter.prototype.postUnretweet = function (params, error, success) {
    var path = '/statuses/unretweet/:id.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};

Twitter.prototype.postReportSpam = function (params, error, success) {
    var path = '/users/report_spam.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};
...
Twitter.prototype.doPost = function (url, post_body, error, success) {
    ...
    this.oauth.post(url, this.accessToken, this.accessTokenSecret, post_body, "application/x-www-form-urlencoded", function (err, body, response) {
        console.log('La peticion tiene un statusCode: ' + response.statusCode)
        if (!err && response.statusCode >= 200 && response.statusCode < 300) {
            success(body);
        } else {
            error(err, response, body);
